 ...
 *                                             \t tab
 *                                             \b 退格
 *                             布尔型 boolean 只含有 true 和 false 两种值 必须小写，默认值是false
 ...
 *                                   浮点型(float,double)
 *                                   float 单精度浮点型 4个字节 值域位 -3.403E38 ~ 3.403E38 定义时在值的后面加F
 *                                   double 双精度浮点型 8个字节 值域位 -1.798E308 ~ 1.798E308
 *                     2.引用数据类型
...
public class Test02010601 {
	...
	public static void main(String[] args) {
		...
		System.out.println(Integer.toBinaryString(16));//转换成八进制
		System.out.println(Integer.toBinaryString(100));//转换成十六进制
		//自动补全返回值Ctrl+1
